<div class="fixed w-[99vw] bg-slate-700 z-50">
    <nav class="max-w-[90rem] mx-auto h-10 px-20 flex justify-between space-x-24 items-center bg-slate-700 text-slate-100">
        <ul class="flex space-x-7 font-semibold">
            ...
            <x-navbar-link href="#">Proyects</x-navbar-link>
            <x-navbar-link href="#">Contacts</x-navbar-link>
        ...
        <ul class="flex space-x-7 items-center">
            ...
            <li class="flex">
                ...
                <div>
                    <select class="px-1 bg-transparent bg-slate-200 focus:ring-blue-500 focus:border-blue-500 peer cursor-pointer appearance-none hover:bg-slate-400" name="lang" id="lang">
