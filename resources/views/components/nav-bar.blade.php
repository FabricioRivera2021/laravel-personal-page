...
>
    <div class="fixed w-[100vw] bg-slate-700 z-50">
        ...
        <nav class="transform transition duration-300 inset-0 md:max-w-[80rem] 2xl:max-w-[90rem] mx-auto sm:h-10 px-20 flex flex-col sm:flex-row justify-between sm:space-x-24 items-center bg-slate-700 text-slate-100"
        :class="{'-translate-x-full opacity-0':isOpen === false, 'translate-x-0 opacity-100': isOpen === true}">
            <ul class="flex flex-col sm:flex-row md:space-x-7 font-semibold items-center">
            ...
            <ul class="flex flex-col sm:flex-row sm:space-x-7 items-center justify-center">
                ...
                <li class="flex">
                    ...
                    <div>
                        <div class="px-1 bg-transparent bg-slate-200 focus:ring-blue-500 appearance-none sm:space-x-1 flex">
